        ...
        */
        ...
        function _getParams(level){
            ...
            if(/=#/.test(url2)){
                for(var i = 0; i < level; i++){
                    params = params.replace(/=#/, '=' + _dValues[i]);
                }
            }else{
                for(var i = 0; i < level; i++){
        ...
        function _getJqObjs(){
            if($('#' + _ids[0]).is('select')){
                ...
                for(var i = 0; i < _casLen; i++){
                    var o = $('#' + _ids[i]).html('<select name="' + _names[i] + '"></select>'), s = o.find('>select');
        ...
        function _onChange(o, level, flag){
            o.bind('change', function(){
                var params = '', paramObj = {}, data, index = level;
        ...
        function _sortString(a, b){
            return (a[_tName[_level]] > b[_tName[_level]]) ? _sort : -_sort;
        }
    }
});