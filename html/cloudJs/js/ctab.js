    ...
    ctab: function(options){
        ...
        if(!options || $.isPlainObject(options)){
            ...
            _self.each(function(i, ele){
                ...
                var onSelectTab = _args[1].onSelectTab || $.noop;
            ...
            _self.each(function(i, ele){
                ...
                var onRemoveTab = _args[1].onRemoveTab || $.noop;
            ...
            _self.each(function(i, ele){
                ...
                var onRefreshTab = _args[1].onRefreshTab || $.noop;
            ...
            _self.each(function(i, ele){
                ...
                var onGetTab = _args[1].onGetTab || $.noop;
            ...
            _self.each(function(i, ele){
                ...
                var onUpdateTab = _args[1].onUpdateTab || $.noop;
        ...
        function _doAddTab(panels){
            var self = this, cObj = self._cloudjsCtabObj,
                ...
                item, liHtml, selectIndex = -1, nowNum, length, eachWidth, newLis = [], newLi, tabId, indexs=[];
        ...
        function _doLoadPanel(index, panelId){
            ...
            if(item.type === 'iframe'){
                panel.html('<iframe frameborder="0" src="' + item.url + '" class="slide_iframe"></iframe>');
        ...
        function _doSelectTab(index){
            ...
            return _doGetTab.call(self, [index]);
        }
        ...
        function _setPanelStyle(){
            var self = this, cObj = self._cloudjsCtabObj,
                myTab = _getTabJqNode.call(self),
                height = $(self).height() - myTab.tabHead.outerHeight(true);
        ...
        function _getTabWidth(width, count){
            ...
            var width = parseFloat(width),
                eachWidth = (width - 10) / count - _CTAB_MARGIN - _CTAB_BORDER_WIDTH;
...
//            return (eachWidth - _CLOSE_BTN_WIDTH - _REFRESH_BTN_WIDTH > _ctab_MAX_WIDTH ? _ctab_MAX_WIDTH : (eachWidth - _CLOSE_BTN_WIDTH - _REFRESH_BTN_WIDTH));
    ...
    require: ['../css/' + cloudjs.themes() + '/ctab.css']
});